    ...
    return (
        <>
            <div className="products-header-wrapper">
                <img src="/assets/images/career.jpeg" alt="Career" />
                        ...
                        <div className="col-md-12 apply-form">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Date Of Birth:</label>
                                            <input
                                                type="date"
                                                className="form-control"
                                                name="apply_dob"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Marital Status:</label>
                                            <select
                                                className="form-control"
                                                name="apply_m_status"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Gender:</label>
                                            <select
                                                className="form-control"
                                                name="apply_gender"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Permanent Address:</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Current Address:</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                placeholder="1446 Beatty Ave, Cambrige OH 43725"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">CNIC:</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Job Type:</label>
                                            <select
                                                className="form-control"
                                                name="apply_job_type"
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Currently Studying:</label>
                                            <select
                                                className="form-control"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Degree:</label>
                                            <select
                                                className="form-control"
                                                name="apply_degree"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Institution:</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            <label className="col-form-label required">Work Experience:</label>
                                            <textarea
                                                className="form-control"
                                                rows="3"
                                                name="apply_work_exp"
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Expected Salary:</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">How did you hear about us?:</label>
                                            <select
                                                className="form-control"
                                                name="apply_resp"
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label className="col-form-label required">Upload CV:</label>
                                            <input
                                                type="file"
                                ...
                                <div className="modal-footer">
                                    ...
                                    <a href="/career" className="btn form-sub">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
